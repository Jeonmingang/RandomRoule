...
public class UltimateRoulette extends JavaPlugin {
    ...
    @Override public void onEnable() {
        ...
        getCommand("roulette").setTabCompleter(new RouletteCommand(this));
        if (getCommand("package") != null) {
            ...
            getCommand("package").setTabCompleter(pc);
        }
        if (getCommand("package").setExecutor(new com.minkang.ultimateroulette.pkg.cmd.PackageCommand(this));
